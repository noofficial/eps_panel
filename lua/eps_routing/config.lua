...
EPS.Config = {
  ...
  { id = "hydroponics",               label = "Hydroponics Systems",            min = 0, max =  18, overdrive =  22, default = 14 },
  { id = "beer_taps",                 label = "Beverage Dispensers",            min = 0, max =  12, overdrive =  14, default = 10 },
  { id = "lighting",                  label = "Ambient Lighting",               min = 0, max =  20, overdrive =  24, default = 16 },
  { id = "pattern_buffers",           label = "Pattern Buffers",                min = 0, max =  30, overdrive =  36, default = 24 },
  { id = "heisenberg_compensators",   label = "Heisenberg Compensators",        min = 0, max =  26, overdrive =  31, default = 21 },
  { id = "transporter_pad",           label = "Transporter Pad Grid",           min = 0, max =  24, overdrive =  29, default = 19 },
  { id = "holoemitters",              label = "Holoemitters",                   min = 0, max =  28, overdrive =  34, default = 22 },
  { id = "holodeck_safety",           label = "Holodeck Safety Interlocks",     min = 0, max =  20, overdrive =  24, default = 16 },
